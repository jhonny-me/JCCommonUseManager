...
- (void)buildDataAndUI {
    ...
    _label = [[UILabel alloc] initWithFrame:CGRectMake(self.backgroundStarView.bounds.origin.x+self.backgroundStarView.bounds.size.width + 60,
                                                       self.backgroundStarView.bounds.origin.y,
                                                       60,
                                                       self.backgroundStarView.bounds.size.height)];
...
- (void)layoutSubviews {
    ...
    _label.text = [NSString stringWithFormat:@"%.f分", self.scorePercent*10];
